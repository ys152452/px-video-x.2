function InitPxVideo(options) {
  ...
  obj.progressBar.addEventListener("click", function(e) {
      var outLeft = $('.videoplay').eq(0).offset().left
    obj.pos = (e.pageX - this.offsetLeft - outLeft) / this.offsetWidth;
  ...
  obj.progressBar.addEventListener("mousemove", throttle(60, function(e) {
    var outLeft = $('.videoplay').eq(0).offset().left
    ...
    obj.progressBarHoverContainer.style.left = e.pageX - outLeft - 25 + "px";
